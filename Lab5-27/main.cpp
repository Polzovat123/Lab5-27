...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("D:/Content/quad.obj")) {
            return false;
        }
        
        if (!m_billboardList.Init("D:/Content/monster_hellknight.png")) {
            return false;
        }
               
        m_pTexture = new Texture(GL_TEXTURE_2D, "D:/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "D:/Content/normal_map.jpg");
